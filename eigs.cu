...
/*
 * eigs computes the smallest n_eigs eigenvalues for dev_l and the
 ...
 *
 * NOTICE: dev_l will be overwritten in the process of computing eigenvectors.
 */
...
void eigs(double *F, double *Es, double *dev_l, int n_eigs, int n_patch)
{
    ...
    cudaMemcpy(l, dev_l, n_patch * n_patch * sizeof(double),
