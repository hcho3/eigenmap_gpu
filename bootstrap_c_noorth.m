function bootstrap_c_noorth(str, par1, par2, num_it)
...
NUM_EIGS = 3;
[status, ~] = system(sprintf('./eigenmap_c_noorth %s.mat %d %d %d %d', str, ...
...
print('-depsc2', '-r1200', ...
      sprintf('results/%s/%s_%d_%d_it%d_C_noorth_lanczos.eps',...
